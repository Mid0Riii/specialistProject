...
class SpecialistAdmin(ImportExportModelAdmin):
    ...
    list_display = ['spe_name','spe_code',  'spe_gender', 'spe_birth','spe_cid', 'spe_company','spe_ctg1','spe_ctg2','spe_info']
    list_filter = ['spe_code', 'spe_name', 'spe_gender', 'spe_birth','spe_cid', 'spe_company', 'spe_tel', 'spe_title', 'spe_job',
